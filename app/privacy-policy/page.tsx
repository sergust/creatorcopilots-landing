...
Payment Information: We collect payment details to process your orders securely. However, we do not store your payment information on our servers. Payments are processed by Lemon Squeezy, a trusted third-party payment processor.
Uploaded Content: We collect video files and screenshots you upload for analysis purposes.
Analysis Data: We store analysis results including video transcripts, retention data, and AI-generated recommendations.
...
- Payment processing
- User authentication
- Providing video analysis services
- Email communications and customer support

3. Data Sharing

We share data with the following third-party service providers to deliver our services:
- Clerk: Authentication services
- Lemon Squeezy: Payment processing
- Resend: Email delivery
- Anthropic (Claude AI): Video and image analysis
